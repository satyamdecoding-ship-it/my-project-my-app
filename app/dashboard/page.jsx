...
//             Welcome to Dashboard, Mr {username}
//           </h1>
...
//             This website helps people remember the work they need to do
//             throughout the day.
//           </p>
...
export default function DashboardPage() {
  ...
  useEffect(() => {
    if (!username) {
      // If no username in query, redirect to sign-in
      router.push("/sign-in");
    }
  }, [username, router]);
    ...
    <main className="dashboard">
      <div className="dashboard-overlay">
        <div className="dashboard-card">
          ...
          <p className="dashboard-subtitle">This is your dashboard page.</p>
          <hr />
          <h2 className="dashboard-heading">Summary</h2>
          <p className="dashboard-text">
